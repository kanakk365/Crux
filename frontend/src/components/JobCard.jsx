  ...
  return (
    ...
    <div className="w-full border-2 border-gray-200 p-4 rounded-lg hover:shadow-xl duration-300 cursor-pointer">
      <div className="flex w-full items-center justify-between">
        ...
        <div className="border-2 aspect-square h-[2.9rem] rounded-md"><img src="https://www.shutterstock.com/image-vector/circle-line-simple-design-logo-600nw-2174926871.jpg" alt="" /></div>
      </div>
