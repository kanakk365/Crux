...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-8 m-auto" >
      <div className="container mx-auto px-16">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Crux</h2>
            <p className="text-sm">© 2024 Your Company. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0 sm:block hidden">
            <a href="https://facebook.com" className="hover:text-gray-400 text-[#011627]" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="text-[#011627] hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-gray-400 text-[#011627]" aria-label="LinkedIn">
